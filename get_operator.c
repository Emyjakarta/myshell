#include "shell.h"
/**
 * obtain_operators-obtain logical operators
 * @str: string
 * @operators: logical operators
 * @size: maximum number of logical operators
 */
void obtain_operators(char **str, OperatorInfo *operators, int size)
{
	...
	operators[count].position = -1; /**
					  * Setting a special position to indicate the end of the array
					  */
